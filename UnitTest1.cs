...
namespace Test
{
    ...
    {
        [TestMethod]
        public void StartingKnapsackLenght()  /*Sprawdzenie, czy jeœli co najmniej jeden przedmiot spe³nia ograniczenia, to zwrócono co najmniej jeden element.*/
        {
        ...
        [TestMethod]
        public void EmptySnapback()     /*Sprawdzenie, czy jeœli ani jeden przedmiot nie spe³nia ograniczeñ, to zwrócono puste rozwi¹zanie.*/
        {
        ...
        [TestMethod]
        public void FillingTheKnapsack() /*Sprawdzenie, czy jeœli co najmniej jeden przedmiot spe³nia ograniczenia, to zwrócono co najmniej jeden element.*/
        {
            Knapsack knapsack = new Knapsack(1, 1);
        ...
        [TestMethod]    /*Sprawdzenie poprawnoœci liczenia pojemnoœci*/
        ...
        public void ItemsOrder() /*Sprawdzenie, czy kolejnoœæ przedmiotów ma wp³ywa na znalezione rozwi¹zanie. (ma)*/
        {
